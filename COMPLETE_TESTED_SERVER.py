...
async def get_viral_videos(
    ...
    """Get viral videos with different thumbnails for each video"""
    try:
        ...
        # DIFFERENT working thumbnails for each video (matching the URLs above)
        working_thumbnails = [
            "https://i.ytimg.com/vi/dQw4w9WgXcQ/hqdefault.jpg",   # Rick Roll
            "https://i.ytimg.com/vi/9bZkp7q19f0/hqdefault.jpg",   # Gangnam Style
            "https://i.ytimg.com/vi/kJQP7kiw5Fk/hqdefault.jpg",   # Despacito
            "https://i.ytimg.com/vi/fJ9rUzIMcZQ/hqdefault.jpg",   # Shape of You
            "https://i.ytimg.com/vi/YQHsXMglC9A/hqdefault.jpg",   # Hello
            "https://i.ytimg.com/vi/CevxZvSJLk8/hqdefault.jpg",   # Roar
            "https://i.ytimg.com/vi/RgKAFK5djSk/hqdefault.jpg",   # Wrecking Ball
            "https://i.ytimg.com/vi/hT_nvWreIhg/hqdefault.jpg",   # Counting Stars
            "https://i.ytimg.com/vi/iGk5fR-t5AU/hqdefault.jpg",   # Firework
            "https://i.ytimg.com/vi/nfWlot6h_JM/hqdefault.jpg",   # Shake It Off
            "https://i.ytimg.com/vi/JGwWNGJdvx8/hqdefault.jpg",   # Perfect
            "https://i.ytimg.com/vi/SlPhMPnQ58k/hqdefault.jpg",   # Someone Like You
            "https://i.ytimg.com/vi/60ItHLz5WEA/hqdefault.jpg",   # Faded
            "https://i.ytimg.com/vi/pRpeEdMmmQ0/hqdefault.jpg",   # Waka Waka
            "https://i.ytimg.com/vi/kffacxfA7G4/hqdefault.jpg"    # Baby Shark
        ]
        ...
        for i in range(limit):
            video = {
                ...
                "thumbnail": working_thumbnails[i % len(working_thumbnails)],  # DIFFERENT thumbnail for each
        ...
        for i in range(min(limit, 3)):
            fallback_videos.append({
                ...
                "url": fallback_urls[i],
                "thumbnail": fallback_thumbnails[i],
                "platform": "youtube",
